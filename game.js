...
console.log('MU PDL Survival build: v23 - city walls and region gates');
...
function addWorldEnvironment(){
  ...
  addLorenciaTown();
  if(state.world==='lorencia') addLorenciaRegions();
  addForestAndRocks();
  addMountainBorder();
}
    ...
    LORENCIA_REGIONS.forEach((region, ridx)=>{
      ...
      for(let i=0;i<count;i++){
        ...
        for(let tries=0; tries<40; tries++){
          ...
          if(Math.hypot(x-LORENCIA_SAFE_ZONE.x,z-LORENCIA_SAFE_ZONE.z)>LORENCIA_SAFE_ZONE.radius+14 && canStandAt(x,z,NPC_RADIUS,null)) break;
        }
...
// Added city wall/gates region layout placeholder update.
